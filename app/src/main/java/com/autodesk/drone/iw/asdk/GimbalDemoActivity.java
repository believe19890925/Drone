...
public class GimbalDemoActivity extends Activity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, DJIDrone.getDroneType().toString());
        if (DJIDroneType.DJIDrone_Inspire1 != DJIDrone.getDroneType() && DJIDroneType.DJIDrone_Phantom3_Professional != DJIDrone.getDroneType() && DJIDroneType.DJIDrone_Phantom3_Advanced != DJIDrone.getDroneType()) {
