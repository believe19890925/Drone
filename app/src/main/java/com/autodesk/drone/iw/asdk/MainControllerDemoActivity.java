...
public class MainControllerDemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSendOnBoardBtn.setOnClickListener(new View.OnClickListener() {
        ...
        mSetIocEnableBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                mPopupNumberPicker = new PopupNumberPicker(m_context,
                        strlist,
                        new CameraProtocolDemoActivity.pickerValueChangeListener(){
                            ...
                            public void onValueChange(int pos1, int pos2) {
                                ...
                                if(pos1 == 1){
                                    DJIDrone.getDjiMC().setMultiControlMode(true, new DJIExecuteResultCallback() {
                                        ...
                                        public void onResult(DJIError mErr)
                                        {
                                            ...
                                            if(mErr.errorCode == DJIError.RESULT_OK){
                                                DJIDrone.getDjiMC().setAircraftFuctionType(DJIMainControllerTypeDef.DJIMcFunctionType.Enable_IOC, new DJIExecuteBooleanResultCallback() {
                                    ...
                                    DJIDrone.getDjiMC().setAircraftFuctionType(DJIMainControllerTypeDef.DJIMcFunctionType.Disable_IOC, new DJIExecuteBooleanResultCallback() {
        ...
        if(DJIDrone.getDroneType() != DJIDroneTypeDef.DJIDroneType.DJIDrone_M100){
