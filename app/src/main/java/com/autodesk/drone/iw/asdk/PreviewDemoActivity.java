...
//                    }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DJILogHelper.getInstance().LOGD(TAG, "DJIDrone.getDjiCamera()="+DJIDrone.getDjiCamera(), false, true);
        ...
        DJILogHelper.getInstance().LOGD(TAG, "DJIDrone.getDroneType()="+DJIDrone.getDroneType(), false, true);
