...
import com.autodesk.drone.iw.asdk.MainControllerDemoActivity.Task;
...
public class BatteryInfoDemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DJIDroneType.DJIDrone_Inspire1 != DJIDrone.getDroneType() || DJIDroneType.DJIDrone_Phantom3_Advanced != DJIDrone.getDroneType() || DJIDroneType.DJIDrone_Phantom3_Professional != DJIDrone.getDroneType()) {
